# LDAP server
## @isx25633105 ASIX M06-ASO Curs 2021-2022

### PAM Containers:

 * **isx25633105/samba21:pam** Container PAM base per practicar autenticació unix i LDAP.
...
``` 
docker run --rm --name ldap.edt.org -h ldap.edt.org --net 2hisix -d isx25633105/ldap21:group
docker run --rm --name pam.edt.org -h pam.edt.prg --net 2hisix --privileged -it isx25633105/pam21:base
